...
class User {
	...
	public function removeFriend($user_to_remove){
		...
		// removing friend details from both the users column as the removal has to be mutual
	...
	public function sendRequest($user_to){
		$user_from=$this->user['username'];// loged in user name details who is sending request

		$query=mysqli_query($this->con,"INSERT friend_requests VALUES ('','$user_to','$user_from')");
	}
