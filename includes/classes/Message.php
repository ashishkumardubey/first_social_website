		...
		class Message {
			...
			public function getLatestMessage($userLoggedIn,$user2)
			{
				...
				//Timeframe
					...
					array_push($details_array, $sent_by); // who has sent
					array_push($details_array, $row['body']);// details of the message body
					array_push($details_array, $time_message);//timeframe 
			...
			public function getConvos() {
		        ...
		        foreach ($convos as $username) {
		            ...
		            $return_string .= "<a href='messages.php?u=$username'> <div class='user_found_messages'>
										<img src='" . $user_found_obj->getProfilePic() . "' style='border-radius: 30px; margin-right: 5px;'>
										" . $user_found_obj->getFirstAndLastName() . " <br>
										<span class='timestamp_smaller' id='msg_time'> " . $latest_message_details[2] . "</span>
										<p id='msg_sniplet' style='margin: 0;'>" . $latest_message_details[0] . $split . " </p>
										</div>
										</a>";
		        }
